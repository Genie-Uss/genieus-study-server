...
public class UserValidationException extends ValidationException {
  ...
  private static final String INVALID_EMAIL_FORMAT = "이메일은 %s로 구성된 아이디와 도메인으로 구성되어야 합니다.";
  ...
  private static final String INVALID_ROLE_NAME = "잘못된 사용자 역할입니다: %s";
  ...
  public static UserValidationException invalidUserRole(String userRole) {
    return new UserValidationException(INVALID_ROLE_NAME.formatted(userRole));
  }
}
